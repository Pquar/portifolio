...
export default async function Projects() {
  ...
  return (
    <Container className="pt-4 lg:pt-12">
      <PageHeader
        title="Projects"
        description="Coleções dos meus projetos paralelos de código aberto. Algumas coisas legais que criei com colegas ou apenas por diversão, para resolver problemas do mundo real."
