...
o construtor não prisa ter todos os atributos
...
public class Main {
    public static void main(String[] args) {
        ...
        clon.setEndereco("rua");
        System.out.println(clon.getNome()+" - " +clon.getEndereco() );
...
- Padronização(Nomenclatura, metodos …)
...
byName: Buscado um metodo set que corresponde ao nome do bean
