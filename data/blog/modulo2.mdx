...
<figure className="mx-auto flex max-w-full flex-col items-center">
  <img
    src="/static/images/modulo/vscode.png"
    alt="Explorador de arquivos do VS Code"
    className="max-w-full px-12"
  />
  <img
    src="/static/images/modulo/vscode-src.png"
    alt="Explorador de arquivos do VS Code"
    className="max-w-full px-12"
  />
...
<img src="images/logo-aclonm.png" alt="Logo da empresa" />
...
<figure className="mx-auto flex max-w-full flex-col items-center">
  <img
    src="/static/images/modulo/dom.jpg"
    alt="Camadas do modelo TCP/IP"
    className="max-w-full bg-white px-12"
  />
  <figcaption className="text-center">
    Document Object Model.{' '}
    <a href="https://www.hostinger.com.br/tutoriais/dom-o-que-e">Fonte: Hostinger</a>
  </figcaption>
</figure>
